...
#include "../../../../../FreeCAD/src/Gui/ProgressDialog.h"
...
struct qt_meta_stringdata_CLASSGuiSCOPEProgressDialogENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSGuiSCOPEProgressDialogENDCLASS = QtMocHelpers::stringData(
    "Gui::ProgressDialog",
    "onCancel",
    "",
    "resetEx",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSGuiSCOPEProgressDialogENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Gui::ProgressDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QProgressDialog::staticMetaObject>(),
    qt_meta_stringdata_CLASSGuiSCOPEProgressDialogENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSGuiSCOPEProgressDialogENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSGuiSCOPEProgressDialogENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void Gui::ProgressDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->setRangeEx((*reinterpret_cast< std::add_pointer_t<int>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        case 3: _t->setValueEx((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
...
void *Gui::ProgressDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSGuiSCOPEProgressDialogENDCLASS.stringdata0))
