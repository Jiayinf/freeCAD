...
public:
    ...
    void setupUi(QWidget *DownloadItem)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/process-stop.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/document-open.svg"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
