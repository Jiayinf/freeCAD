...
#include "../../../../../../../../../../FreeCAD/src/Mod/TechDraw/Gui/QGMText.h"
...
struct qt_meta_stringdata_CLASSTechDrawGuiSCOPEQGMTextENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTechDrawGuiSCOPEQGMTextENDCLASS = QtMocHelpers::stringData(
    "TechDrawGui::QGMText",
    "dragging",
    "",
    "hover",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTechDrawGuiSCOPEQGMTextENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TechDrawGui::QGMText::staticMetaObject = { {
    QMetaObject::SuperData::link<QGCustomText::staticMetaObject>(),
    qt_meta_stringdata_CLASSTechDrawGuiSCOPEQGMTextENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTechDrawGuiSCOPEQGMTextENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTechDrawGuiSCOPEQGMTextENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<QGMText, std::true_type>,
        // method 'dragging'
...
void TechDrawGui::QGMText::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &QGMText::dragging; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &QGMText::hover; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (QGMText::*)(bool );
            if (_t _q_method = &QGMText::selected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (QGMText::*)();
            if (_t _q_method = &QGMText::dragFinished; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
void *TechDrawGui::QGMText::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTechDrawGuiSCOPEQGMTextENDCLASS.stringdata0))
